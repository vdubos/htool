...
class VirtualLowRankGenerator {
  public:
     ...
     *
     * @param A VirtualGenerator given to generator coefficient of the approximated kernel.
     * @param t target Cluster that defines the rows of the approximated block
     * @param s source Cluster that defines the columns of the approximated block
     * @param epsilon input tolerance
     * @param rank On input, given tolerance or if \p rank <0, the approximation is expected to continue up to an epsilon tolerance. On output, it is the obtained rank at the end of the low rank approximation.
     * @param U \f$ \mathbf{U} \f$-part of the low-rank approximation on output
     * @param V \f$ \mathbf{V} \f$-part of the low-rank approximation on output
     */
